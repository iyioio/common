...
Documentation for @iyio/react-common is a work in progress



``` ts
type BaseLayoutAnimationSpeed='fast'|'quick'|'slow'|'extraSlow';

interface BaseLayoutAnimationProps{

    /**
     * Transitions all css properties
     */
    transAll?:boolean|BaseLayoutAnimationSpeed;

    /**
     * Transitions the transform css property
     */
    transTransform?:boolean|BaseLayoutAnimationSpeed;

    /**
     * Transitions the opacity css property
     */
    transOpacity?:boolean|BaseLayoutAnimationSpeed;

    /**
     * Transitions the color css property
     */
    transColor?:boolean|BaseLayoutAnimationSpeed;

    /**
     * Transitions the background-color css property
     */
    transBackgroundColor?:boolean|BaseLayoutAnimationSpeed;

    /**
     * Transitions the transform css property
     */
    transCommon?:boolean|BaseLayoutAnimationSpeed;
}
```
