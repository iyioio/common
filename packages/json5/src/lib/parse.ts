import { Json5Reviver } from './json5-types.js';
...
function newToken (type:any, value?:any) {
    return {
        type,
        value,
        line,
...
function syntaxError (message:any):SyntaxError {
