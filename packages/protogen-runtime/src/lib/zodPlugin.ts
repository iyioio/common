...
{
    zodDefPrefix:z.string().optional(),

    /**
     * @default "@common/types"
     */
    zodDefSuffix:z.string().optional(),
     ...
     * @default '@common/types'
     */
    zodImportPath:z.string().optional(),
})
...
export const zodPlugin:ProtoPipelineConfigurablePlugin<typeof ZodPluginConfig>=
{
    ...
    generate:async ({
        ...
        zodDefPrefix:defPrefix='',
        zodDefSuffix:defSuffix='Scheme',
        zodOutPath='models.ts',
        zodImportPath='@common/types'
    })=>{
        ...
        for(const node of nodes){
            ...
            if(added){
                importMap[node.name]=zodImportPath;
            }
