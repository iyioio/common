export const mdxGrammar = {
    ...
    repository: {
        ...
        'commonmark-block-quote': {
            begin: '(?:^|\\G)[\\t ]*(>)[ ]?',
            beginCaptures: {
                '0': { name: 'markup.quote.mdx' },
                '1': { name: 'punctuation.definition.quote.begin.mdx' },
            },
        ...
        'commonmark-code-fenced': {
            patterns: [
                ...
                { include: '#commonmark-code-fenced-style' },
                { include: '#commonmark-code-fenced-convo' },
            ...
            patterns: [
                {
                    ...
                    endCaptures: {
                        '1': { name: 'string.other.end.code.fenced.mdx' },
                    },
            ...
            patterns: [
                {
                    ...
                    name: 'markup.code.style.mdx',
                    patterns: [
                        {
                            begin: '(^|\\G)(\\s*)(.*)',
                            contentName: 'meta.embedded.style',
                            patterns: [{ include: 'source.atdot' }],
                            while: '(^|\\G)(?![\\t ]*([`~]{3,})[\\t ]*$)',
                        },
                    ],
                },
            ...
            patterns: [
                {
                    ...
                    name: 'markup.code.convo.mdx',
                    patterns: [
                        {
                            begin: '(^|\\G)(\\s*)(.*)',
                            contentName: 'meta.embedded.convo',
                            patterns: [{ include: 'source.convo' }],
                            while: '(^|\\G)(?![\\t ]*([`~]{3,})[\\t ]*$)',
                        },
                    ],
                },
        ...
        'commonmark-label-end': {
            patterns: [
                ...
                {
                    captures: { '1': { name: 'string.other.end.mdx' } },
                    match: '(\\])',
                },
            ],
        },
        'commonmark-label-start': {
            patterns: [
                ...
                { match: '\\[', name: 'string.other.begin.link.mdx' },
            ],
        },
            ...
            patterns: [
                {
                    begin: '(?:^|\\G)[\\t ]*((?:[*+-]))(?:[ ]{4}(?![ ])|\\t)(\\[[\\t Xx]\\](?=[\\t\\n\\r ]+(?:$|[^\\t\\n\\r ])))?',
                    beginCaptures: {
                        '1': { name: 'variable.unordered.list.mdx' },
                        '2': { name: 'keyword.other.tasklist.mdx' },
                    },
                    patterns: [{ include: '#markdown-sections' }],
                    while: '^(?=[\\t ]*$)|(?:^|\\G)(?:[ ]{4}|\\t)[ ]{1}',
                },
        ...
        'extension-gfm-table': {
            ...
            patterns: [
                {
                    captures: {
                        '1': { patterns: [{ include: '#markdown-text' }] },
                    },
                    match: '(?<=\\||(?:^|\\G))[\\t ]*((?:[^\\n\\r\\\\\\|]|\\\\[\\\\\\|]?)+?)[\\t ]*(?=\\||$)',
                },
        ...
        'extension-mdx-expression-flow': {
            begin: '(?:^|\\G)[\\t ]*(\\{)',
            beginCaptures: {
                '1': { name: 'string.other.begin.expression.mdx.js' },
            },
            contentName: 'meta.embedded.tsx',
            end: '(\\})(?:[\\t ]*$)',
            endCaptures: {
        ...
        'extension-mdx-expression-text': {
            begin: '\\{',
            beginCaptures: {
                '0': { name: 'string.other.begin.expression.mdx.js' },
            },
            contentName: 'meta.embedded.tsx',
            end: '\\}',
            endCaptures: {
