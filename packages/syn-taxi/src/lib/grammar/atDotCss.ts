    ...
    "repository": {
        ...
        "at-rules": {
            "patterns": [
                ...
                {
                    "begin": "(?=@(mobileSmUp|mobileUp|tabletSmUp|tabletUp|desktopSmUp|desktopUp|mobileSmDown|mobileDown|tabletSmDown|tabletDown|desktopSmDown|desktopDown))",
                    "end": "(?<=})(?!\\G)",
                    "patterns": [
                        {
                            "include": "#interpolation"
                        ...
                        {
                            "match": "\\G(@)(mobileSmUp|mobileUp|tabletSmUp|tabletUp|desktopSmUp|desktopUp|mobileSmDown|mobileDown|tabletSmDown|tabletDown|desktopSmDown|desktopDown)",
                            "captures": {
                                "0": {
